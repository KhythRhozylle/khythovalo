...
<head>
    ...
    <style>
:root {
  --valid: rgba(56, 187, 231, 0.3);
  --invalid: rgba(214, 86, 122, 0.3);
  --input: rgba(44, 17, 103, 0.3);
}
...
.register-container {
  ...
  max-width: 100%;
  padding: 2rem;
  background: rgba(120, 194, 9, 0.3);
  border-radius: 15px;
  box-shadow: 0 10px 30px rgba(227, 12, 12, 0.3);
}
